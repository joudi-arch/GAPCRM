      ...
      <div className="grid grid-cols-12 items-center gap-8">
        ...
        <div className="col-span-12 lg:col-span-7">
          ...
          <motion.div
            ...
            className="mt-9 inline-flex max-w-xl items-start gap-3 rounded-2xl px-5 py-4"
            style={{ background: 'rgba(255,255,255,0.06)', border: `1px solid ${world.accent}55` }}
          >
        ...
        {/* right: logo + proof */}
        <div className="col-span-12 flex flex-col items-start gap-10 lg:col-span-5 lg:items-end">
          ...
          <div className="lg:text-right">
            <div className={`${world.font} font-bold leading-none`} style={{ fontSize: 'clamp(3.5rem, 8vw, 7rem)', color: world.accent }}>
